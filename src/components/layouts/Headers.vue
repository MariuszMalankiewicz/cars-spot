<template>
  <section class="w-[95%] md:w-[90%] mx-auto pt-[80px]">
      <div class="flex flex-col gap-[24px]">
        <div>
          <p class="text-start font-robotoCondensed font-normal text-[20px] leading-[32.25px] text-info">Prezentacja firmy</p>
          <div>
            <h2 class="w-full font-bebaszNeue font-semibold text-[40px] leading-[48px] text-dark">Zobacz naszą Galerię zdjęć</h2>
          </div>
        </div>
